...
--> statement-breakpoint
ALTER TABLE "job_listings" ADD CONSTRAINT "job_listings_organizationId_orgnizations_id_fk" FOREIGN KEY ("organizationId") REFERENCES "public"."orgnizations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "organization_user_settings" ADD CONSTRAINT "organization_user_settings_organizationId_orgnizations_id_fk" FOREIGN KEY ("organizationId") REFERENCES "public"."orgnizations"("id") ON DELETE no action ON UPDATE no action;--> statement-breakpoint
